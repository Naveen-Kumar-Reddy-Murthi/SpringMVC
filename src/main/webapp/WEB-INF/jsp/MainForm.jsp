		...
		$
				.ajax({
					...
					success : function(data) {
						var finalData = "<tbody><tr><th>Id</th><th>Name</th><th>Department</th><th>Email</th><th>Image</th></tr>"
								+ data;
...
<body>
	...
	<div class="left-div">
		<sf:form method="POST" modelAttribute="employee" action="saveEmployee"
			...
			<fieldset style="padding: 1em; font: 80%/1 sans-serif; width: 550px;">
				...
				<table cellspacing="0">
					<tr>
						...
						<td><sf:errors path="id" class="control-label" /></td>
					</tr>
					<tr>
